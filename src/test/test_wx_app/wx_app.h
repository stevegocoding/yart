...
{
public: 
	c_render_thread(c_wx_render_window *render_window, 
		sampler_ptr main_sampler, 
		sample_ptr origin_sample, 
		camera_ptr cam, 
...
class c_wx_render_window : public wxScrolledWindow, public c_display
{
public:
	...
	void pause_render(); 
	void resume_render(); 
	virtual void update_display(render_target_ptr render_target); 
