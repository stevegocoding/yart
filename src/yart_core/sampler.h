...
public:
	...
	virtual int get_more_samples(sample_ptr& sample, rng_ptr& rng) = 0;
...
private:
	...
	// Number of samples of each 1D samples patterns
	std::vector<uint32_t> m_1D;
	// Number of samples of each 2D samples patterns
